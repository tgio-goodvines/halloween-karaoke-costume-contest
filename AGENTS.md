...
- `ai-context/KARAOKE_ATTENDEE_LIVE_STATUS_PROGRESS.md` - attendee-safe live karaoke status, co-singer visibility, stage-transition invariants, polling behavior, and verification.
